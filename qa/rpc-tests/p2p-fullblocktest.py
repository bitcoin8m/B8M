...
'''
This reimplements tests from the bitcoin8mj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure bitcoin8md isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoin8md isn't accepted b28
