...
unlocked to sign the Bitcoin8m-Qt.app bundle.
...
allowing somebody to distribute a Bitcoin8m-Qt.app or bitcoin8m-qt-setup.exe with a valid
...
that the bitcoin8m-qt.exe file inside the installer had not been tampered with.
