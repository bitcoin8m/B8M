...
This document provides guidelines for internationalization of the Bitcoin8m Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoin8m_en.ts` remains unchanged.
