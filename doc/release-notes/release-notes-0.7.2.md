Bitcoin8m version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoin8m/files/Bitcoin8m/bitcoin8m-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Bitcoin8m-Qt to crash on Windows when exiting.
