Bitcoin8m Core version 0.10.3 is now available from:

  <https://bitcoin8m.org/bin/bitcoin8m-core-0.10.3/>
...
(see https://github.com/bitcoin8m/bitcoin8m/pull/6793, as well as the 0.11.0
