Bitcoin8m Core version 0.9.4 is now available from:

  https://bitcoin8m.org/bin/0.9.4/
...
this update is incompatible with the Bitcoin8m system and could lead to consensus
forks.

Bitcoin8m Core released binaries from https://bitcoin8m.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin8m/+archive/ubuntu/bitcoin8m
- A third-party or self-compiled Bitcoin8m Core

upgrade to Bitcoin8m Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
