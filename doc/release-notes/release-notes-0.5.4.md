Bitcoin8m version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin8m/files/Bitcoin8m/bitcoin8m-0.5.4/
...
http://gitorious.org/bitcoin8m/bitcoin8md-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoin8m-Qt notifications under Growl 1.3.
Increase required age of Bitcoin8m-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin8m properly when installing Bitcoin8m-Qt over it. (Windows)
