Download URL: https://sourceforge.net/projects/bitcoin8m/files/Bitcoin8m/bitcoin8m-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 B8M fee schedule (users still pay 0.01 B8M per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoin8m00 - #bitcoin8m99
