Bitcoin8m Core version 0.9.2.1 is now available from:

  https://bitcoin8m.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 B8M to 0.01 B8M
...
- Fix "Start bitcoin8m on system login"
