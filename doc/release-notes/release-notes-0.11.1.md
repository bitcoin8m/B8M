Bitcoin8m Core version 0.11.1 is now available from:

  <https://bitcoin8m.org/bin/bitcoin8m-core-0.11.1/>
...
(see https://github.com/bitcoin8m/bitcoin8m/pull/6795).
...
one was randomly violated by all deployed bitcoin8m software prior to
...
Bitcoin8m Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Bitcoin8mj has done so for a similar span of time.
Bitcoin8mjs and electrum have been more recently updated.
...
[1] On the Malleability of Bitcoin8m Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/bitcoin8m/paper_9.pdf
...
(see https://github.com/bitcoin8m/bitcoin8m/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libbitcoin8mconsensus: avoid a crash in multi-threaded environments
