Bitcoin8m-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoin8m/files/Bitcoin8m/bitcoin8m-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoin8m
...
New/changed settings (command-line or bitcoin8m.conf file)
--------------------------------------------------------
