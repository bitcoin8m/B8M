...
// Copyright (c) 2009-2012 The Bitcoin8m Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Bitcoin8m/$1-%s The Bitcoin8m/' %s"
REGEX_CURRENT= re.compile("%s The Bitcoin8m" % year)
