...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitcoin8m"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoin8m Core"),
     ...
     * override -datadir in the bitcoin8m.conf file in the default data directory
     * (to be consistent with bitcoin8md behavior)
     */
    if(dataDir != getDefaultDataDirectory())
