...
#ifndef BITCOIN8M_QT_BITCOIN8MUNITS_H
#define BITCOIN8M_QT_BITCOIN8MUNITS_H
...
/** Bitcoin8m unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class Bitcoin8mUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit Bitcoin8mUnits(QObject *parent);

    /** Bitcoin8m units.
      @note Source: https://en.bitcoin8m.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        B8M,
...
typedef Bitcoin8mUnits::Unit Bitcoin8mUnit;

#endif // BITCOIN8M_QT_BITCOIN8MUNITS_H
