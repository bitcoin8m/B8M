// Copyright (c) 2013-2015 The Bitcoin8m Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBitcoin8mAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBitcoin8mAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBitcoin8mAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBitcoin8mAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBitcoin8mAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcoin8mAddress(arr[0].get_str()).Get() == demoAddress.Get());
