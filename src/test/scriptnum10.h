...
#ifndef BITCOIN8M_TEST_SCRIPTNUM10_H
#define BITCOIN8M_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoin8m Core 0.10.0, for cross-comparison.
 */
public:
