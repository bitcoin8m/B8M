...
#define BOOST_TEST_MODULE Bitcoin8m Test Suite

#include "test_bitcoin8m.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitcoin8m_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
