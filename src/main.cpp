...
#if defined(NDEBUG)
# error "Bitcoin8m cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitcoin8m Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s B8M additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("bitcoin8m-scriptch");
